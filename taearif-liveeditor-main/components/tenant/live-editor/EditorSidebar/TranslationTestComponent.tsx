      ...
      <CardContent className="space-y-4">
        <div className="p-4 bg-blue-50 rounded-lg">
          ...
          <div className="space-y-2 text-sm">
            <p><strong>Save Changes:</strong> {t("editor.save_changes")}</p>
            <p><strong>Add Component:</strong> {t("editor.add_component")}</p>
            <p><strong>Delete Component:</strong> {t("editor.delete_component")}</p>
            <p><strong>Cancel:</strong> {t("common.cancel")}</p>
            <p><strong>Preview:</strong> {t("editor.preview")}</p>
