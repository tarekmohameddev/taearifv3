...
export const calculateOptimalDropPosition = (
  ...
  console.log('🔍 [UTILS] calculateOptimalDropPosition called:', { dragY, elementsCount: targetElements.length });
  ...
  console.log('🔍 [UTILS] No optimal position found, returning end:', targetElements.length);
...
export const optimizeForDevice = () => {
  ...
  return {
    ...
    shouldReduceAnimations: capabilities.isMobile || animationPrefs.prefersReducedMotion,
