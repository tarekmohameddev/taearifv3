          ...
          <div className="w-full md:w-[50%] order-2 md:order-2 flex flex-col justify-center text-right">
            ...
            <div className="mb-6">
              <p className="text-base md:text-lg text-[#5c3e2a] leading-relaxed">
                ندير عنك كل شيء… من الإعلان حتى التوقيع. في باهية، نوفّر لك
                مستأجرًا موثوقًا ونتولى إدارة عملية التأجير بالكامل، من التسويق
                والتواصل، حتى إعداد العقود واستلام الدفعات. كل ذلك باحترافية،
                شفافية، وتجربة تُبقيك مطمئنًا دائمًا
              </p>
            </div>
