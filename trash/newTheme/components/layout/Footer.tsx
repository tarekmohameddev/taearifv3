...
const Footer = () => {
  ...
  return (
    <>
      <footer className="relative z-10 bg-[#8b5f46] pt-16 md:pt-20 lg:pt-24 pb-8">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-8 mb-12">
            ...
            <div className="w-full lg:w-1/2 xl:w-2/5">
              ...
              <ul className="space-y-4 mb-6">
                ...
                <li className="flex items-center gap-3">
                  ...
                  >
                    ...
                    <span className="text-base">contact@baheya.co</span>
                  </a>
                </li>
                <li className="flex items-center gap-3">
                  <a
                  ...
                  >
                    ...
                    <span className="text-base">0542120011</span>
                  </a>
                </li>
              </ul>
              ...
              <p className="text-base leading-relaxed text-white/90">
                نحن هنا لمساعدتك في كل خطوة — من البحث عن العقار المناسب، إلى
                إتمام المعاملة بكل احترافية وشفافية.
              </p>
            </div>
            ...
            <div className="w-full lg:w-1/2 xl:w-3/5 ">
              ...
              <p className="text-base leading-relaxed text-white/90 mb-6">
                كن أول من يتلقى آخر العروض، والأخبار العقارية، ونصائح الاستثمار
                من فريق باهية. املأ خانة رقم الواتساب وسنوافيك بكل جديد
              </p>
