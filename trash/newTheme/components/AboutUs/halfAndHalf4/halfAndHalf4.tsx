...
interface HalfAndHalf4Props {
  image?: string;
  title?: string;
}

export default function HalfAndHalf4({
      ...
      <div className="w-full max-w-[1350px] mx-auto px-4 md:px-6 lg:px-8">
        <div className=" rounded-2xl overflow-hidden">
          <div className="flex flex-col md:flex-row ">
            {/* Left Side - Image (45% من العرض) */}
            <div className="w-full md:w-[50%] order-1 md:order-2 relative h-[300px] md:min-h-[500px] rounded-xl overflow-hidden">
              <Image
                src={image}
                alt="صورة"
                fill
            ...
            <div className="w-full md:w-[50%] bg-[#f5f0e8] flex flex-col justify-center px-6 md:px-8 lg:px-10 py-8 md:py-12 text-right order-2 md:order-1">
              {/* Heading */}
              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-[#d4a574] rounded-xl flex items-center justify-center">
                    <svg
                  ...
                  <div className="flex-1">
                    <h4 className="text-lg md:text-xl font-bold mb-2 text-[#8b5f46]">
                      الشفافية
                    </h4>
