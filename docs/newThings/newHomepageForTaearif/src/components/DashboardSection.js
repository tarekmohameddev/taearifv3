          ...
          <div className="relative z-10 mt-16">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-black mb-8 leading-tight">
                قم بإدارة كامل{" "}
                <span className="text-[#17BD37]">
                  الأعمال التجارية العقارية
                </span>
              </h1>

              {/* Description */}
              <p className="text-xl text-[#6E6E75] mb-8 leading-relaxed max-w-3xl mx-auto">
                الداشبورد في تعاريف يعطيك تحكم كامل — من العقارات والعملاء إلى
                الصفقات والرسائل — كل شي في نظام ذكي مؤتمت يشتغل عنك، مو عليك.
              </p>
