...
export default function FeaturesSectionNew() {
  ...
  return (
    <section id="features-new" className="py-20 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4">
        {/* Title Section */}
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-6xl font-bold text-black mb-8 leading-tight">
            <span className="relative inline-block">
              <span className="relative z-10 text-black">مزايا قوية مصمّمة تخدم شغلك العقاري.</span>
              <span className="ui-e-headline-text ui-e-headline-stroke7">
                <span className="whitespace"></span>
                <span>
                  <span className="ui-e-headline-text ui-e-headline-highlighted relative z-10">للعقارات</span>
        ...
        <div className="relative min-h-[600px]">
          ...
          <div className={`absolute top-20 right-10 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
          ...
          <div className={`absolute top-1/2 left-10 transform -translate-y-1/2 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
          ...
          <div className={`absolute bottom-20 right-10 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
            <div className="flex flex-col items-end gap-4 p-4">
          ...
          <div className={`absolute bottom-20 left-10 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
            <div className="flex flex-col items-start gap-4 p-4">
