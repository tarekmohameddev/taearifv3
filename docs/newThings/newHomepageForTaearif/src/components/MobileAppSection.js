...
const MobileAppSection = () => {
  return (
    <section id="app" className="pt-12 pb-8 sm:pt-16 sm:pb-12 lg:pt-20 lg:pb-16 "
    style={{ zIndex: 50 }}>
          ...
          <div className="bg-[#E7FDF2] p-6 sm:p-8 lg:p-12 rounded-lg order-2 lg:order-1">
            <div className="space-y-6 sm:space-y-8 lg:space-y-10">
              ...
              <motion.p 
                ...
                viewport={{ once: true, margin: "-100px" }}
              >
                تحكم في عقاراتك وعملاءك ورسائلك من أي مكان، بسرعة وأمان، والنظام شغال معك وين ما كنت.
              </motion.p>
