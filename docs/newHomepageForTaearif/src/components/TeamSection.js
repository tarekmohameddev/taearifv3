      ...
      <div className="container mx-auto px-4">
        ...
        >
          <motion.h2 
            ...
            viewport={{ once: true, margin: "-100px" }}
          >
            فريق من المصممين والمهندسين وأهل العقار، يشتغلون مع بعض لتطوير أدوات تساعدك تبيع أسرع وتشتغل أذكى.
          </motion.h2>
        </motion.div>
        ...
        >
          ...
          >
            <motion.p 
              ...
              viewport={{ once: true, margin: "-50px" }}
            >
              نمزج خبرتنا في السوق العقاري مع برمجيات ذكية وسهلة الاستخدام.<br />
              من مواقع المسوّقين إلى أنظمة الـCRM المدعومة بالذكاء الصناعي، هدفنا واحد — نوفّر لك نظام يحوّل المحادثات إلى صفقات حقيقية.
            </motion.p>
          </motion.div>
        </motion.div>
