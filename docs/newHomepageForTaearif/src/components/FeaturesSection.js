      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            {/* CRM Feature */}
            <div className={`absolute -top-10 left-1/2 transform -translate-x-1/2 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
            ...
            {/* AI Feature */}
            <div className={`absolute top-[20%] right-0 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
              <div className="">
            ...
            {/* Website Feature */}
            <div className={`absolute top-1/2 left-1/6 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
            ...
            {/* WhatsApp Feature */}
            <div className={`absolute top-2/3 right-1/6 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
            ...
            {/* Dashboard Feature */}
            <div className={`absolute bottom-1/4 left-1/3 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
              <div className="flex flex-col items-start gap-4 p-4">
            ...
            <div className={`absolute top-1/6 right-1/6 w-14 h-14 transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
              <img 
            ...
            <div className={`absolute bottom-1/6 left-1/6 w-8 h-8 transition-all duration-1000 delay-800 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
              <img 
            ...
            <div className={`absolute top-1/2 right-1/8 w-16 h-16 transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
              <img 
            ...
            <div className={`absolute bottom-1/3 right-1/3 w-16 h-16 transition-all duration-1000 delay-1000 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
              <img 
                src="https://test.kingbellsa.com/wp-content/uploads/2025/10/App-Landing-ornament-1.webp" 
                alt="Ornament" 
                className="w-full h-full object-contain"
            ...
            <div className={`absolute top-1/3 left-1/8 w-9 h-9 transition-all duration-1000 delay-1100 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
              <img 
            ...
            <div className={`absolute bottom-1/2 right-1/4 w-16 h-16 transition-all duration-1000 delay-1200 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
              <img 
