    ...
    "data": [
        {
            ...
            "permissions_list": ["properties.view", "properties.create", "customers.view"]
        }
    ]
}
```
...
```json
{
    ...
    "data": {
        ...
        "permissions_list": ["properties.view", "customers.view", "customers.create", "customers.update"]
    }
}
```
...
```json
{
    ...
    "data": {
        ...
        "permissions_list": ["properties.view", "properties.create", "customers.view", "customers.create", "customers.update", "customers.delete"]
    }
}
```
