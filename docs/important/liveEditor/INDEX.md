# Live Editor Documentation - Complete Index

## 📚 Complete Documentation Set

This is the **master index** for all Live Editor documentation.

**Total**: 18 main documents + 2 indexes = 20 files, organized into 6 categories
...
### Strategy 1: Rapid Onboarding (30 minutes)

```
1. QUICK_START.md (5 min)
2. CORE_CONCEPTS.md (15 min)
3. Skim OVERVIEW.md (10 min)

Result: Working knowledge of system
```

### Strategy 2: Implementation Focus (4 hours)
...
Result: Can add new components
```

### Strategy 3: Debug Focus (3 hours)
...
6. DEBUG_AND_LOGGING.md

Result: Can debug and fix issues
```

### Strategy 4: Complete Mastery (20+ hours)

```
Read all documents in order:
  Level 0: Quick Start (20 min)
  Level 1: Core System (12 hrs)
  Level 2: EditorSidebar (5 hrs)
  Level 3: Practical (4.5 hrs)
...
- Quick fixes → [TROUBLESHOOTING.md](./TROUBLESHOOTING.md) → "Quick Fixes"
...
- **20 documents** (18 main + 2 indexes)
...
5. Keep [API_REFERENCE.md](./API_REFERENCE.md) and [TROUBLESHOOTING.md](./TROUBLESHOOTING.md) handy
...
5. [COMMON_PATTERNS.md](./COMMON_PATTERNS.md)
...
4. [STATE_MANAGEMENT.md](./STATE_MANAGEMENT.md) - Understand stores
...
For AI assistants working with Live Editor:

- [ ] Read QUICK_START.md
- [ ] Read CORE_CONCEPTS.md
- [ ] Understand component.id vs componentName vs type
- [ ] Understand data priority system
- [ ] Understand tempData lifecycle
- [ ] Understand global vs page components
- [ ] Know when to use deep merge
- [ ] Know when to check for global components
- [ ] Can find function signatures in API_REFERENCE
- [ ] Can debug using TROUBLESHOOTING guide

**Minimum for effective assistance**: First 4 items

**Recommended**: All 10 items
...
**For AI**: These docs enable you to work with Live Editor as effectively as a human developer who has spent months learning the system.
