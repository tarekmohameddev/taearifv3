# Inputs1 Component - Store Integration Details

## نظرة عامة

مكون `inputs1` هو مكون النماذج الديناميكية الذي يدعم حالتين مختلفتين:
...
## 12. Key Differences from Grid1

1. **Form Management**: `inputs1` يدير النماذج والبيانات المدخلة
2. **Validation**: يتضمن نظام التحقق من صحة البيانات
3. **API Submission**: يدعم إرسال البيانات إلى API endpoints
4. **Dynamic Fields**: يدعم حقول ديناميكية متعددة الأنواع
5. **State Management**: إدارة حالة النموذج والتحقق من الأخطاء
