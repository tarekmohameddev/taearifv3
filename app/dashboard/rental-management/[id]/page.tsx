...
export default function RentalDetailsPage() {
  ...
  const [sidebarActiveTab, setSidebarActiveTab] = useState<string>("rental-management");
  ...
  return (
    <div className="flex min-h-screen flex-col" dir="rtl">
      ...
      <div className="flex flex-1 flex-col md:flex-row">
        <EnhancedSidebar activeTab={sidebarActiveTab} setActiveTab={setSidebarActiveTab} />
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      ...
                      >
                        <div className="text-right" dir="rtl">
                          ...
                          <p className="text-sm sm:text-base font-semibold text-right">
                            {details.rental.tenant_national_id || "غير محدد"}
                          </p>
                        </div>
