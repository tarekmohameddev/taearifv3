...
class DebugLogger {
  ...
  private formatLog(log: DebugLog): string {
    ...
    const componentName = log.componentName ? `[NAME:${log.componentName}]` : '';
    const componentType = log.componentType ? `[TYPE:${log.componentType}]` : '';
  ...
  log(source: string, action: string, data: any, componentInfo?: {
    componentId?: string;
    componentName?: string;
    componentType?: string;
  }) {
  ...
  logComponentAdd(componentId: string, componentName: string, componentType: string, data: any) {
  ...
  logComponentChange(componentId: string, oldName: string, newName: string, data: any) {
    this.log('COMPONENT_CHANGE', 'CHANGE_COMPONENT', {
  ...
  logEditorStore(action: string, componentId: string, componentName: string, data: any) {
  ...
  logTenantStore(action: string, componentId: string, componentName: string, data: any) {
  ...
  logComponentRender(componentId: string, componentName: string, componentType: string, data: any) {
  ...
  logSidebar(action: string, componentId: string, componentName: string, data: any) {
  ...
  logUserAction(action: string, componentId: string, componentName: string, data: any) {
  ...
  logChange(componentId: string, componentName: string, componentType: string, newData: any, changeType: 'GLOBAL_HEADER' | 'GLOBAL_FOOTER' | 'COMPONENT_UPDATE') {
    if (!this.isEnabled) return;
...
export const logComponentAdd = (componentId: string, componentName: string, componentType: string, data: any) => {
  debugLogger.logComponentAdd(componentId, componentName, componentType, data);
};

export const logComponentChange = (componentId: string, oldName: string, newName: string, data: any) => {
  debugLogger.logComponentChange(componentId, oldName, newName, data);
};

export const logEditorStore = (action: string, componentId: string, componentName: string, data: any) => {
  debugLogger.logEditorStore(action, componentId, componentName, data);
};

export const logTenantStore = (action: string, componentId: string, componentName: string, data: any) => {
  debugLogger.logTenantStore(action, componentId, componentName, data);
};

export const logComponentRender = (componentId: string, componentName: string, componentType: string, data: any) => {
  debugLogger.logComponentRender(componentId, componentName, componentType, data);
};

export const logSidebar = (action: string, componentId: string, componentName: string, data: any) => {
  debugLogger.logSidebar(action, componentId, componentName, data);
};

export const logUserAction = (action: string, componentId: string, componentName: string, data: any) => {
...
export const logChange = (componentId: string, componentName: string, componentType: string, newData: any, changeType: 'GLOBAL_HEADER' | 'GLOBAL_FOOTER' | 'COMPONENT_UPDATE') => {
  debugLogger.logChange(componentId, componentName, componentType, newData, changeType);
};
