...
import { Copy, Plus, Edit, Trash2, ExternalLink, QrCode, Share, BarChart3 } from "lucide-react"
...
export function AffiliateLinksPage() {
  ...
  const handleCreateLink = () => {
    ...
    const campaignParam = newLink.campaign ? `&campaign=${newLink.campaign}` : ""
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-muted-foreground">أنشئ وأدر روابطك التابعة لتتبع الأداء</p>
              </div>
            ...
            {showCreateForm && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>أنشئ رابطاً تابعاً لتتبع النقرات والتحويلات</CardDescription>
                </CardHeader>
                ...
                <Card key={link.id}>
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <CardDescription>تم الإنشاء في {link.createdAt}</CardDescription>
                      </div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        <Input value={link.affiliateUrl} readOnly className="font-mono text-sm" />
                        <Button variant="outline" size="sm" onClick={() => copyToClipboard(link.affiliateUrl)}>
                          <Copy className="h-4 w-4" />
                        </Button>
                        <Button variant="outline" size="sm" onClick={() => window.open(link.affiliateUrl, "_blank")}>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <div className="text-center p-3 border rounded">
                        <p className="text-2xl font-bold text-green-600">{link.earnings.toFixed(2)} ريال</p>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>نظرة عامة على أداء جميع روابطك</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="text-center">
                    <p className="text-3xl font-bold">{links.reduce((sum, link) => sum + link.conversions, 0)}</p>
                    <p className="text-sm text-muted-foreground">إجمالي التحويلات</p>
                  </div>
                  <div className="text-center">
                    <p className="text-3xl font-bold text-green-600">
                      {links.reduce((sum, link) => sum + link.earnings, 0).toFixed(2)} ريال
                    </p>
