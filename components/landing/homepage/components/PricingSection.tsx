    ...
    <section id="pricing" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div
            className={`bg-white border-2 border-[#FF8C24] rounded-lg p-8 relative transition-all duration-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            {/* Popular Badge */}
            ...
            <ul className="space-y-4 mb-8">
              ...
              <li className="flex items-start gap-3 transition-all duration-500 hover:translate-x-2">
                ...
                <span className="text-gray-700 transition-all duration-500 hover:text-[#FF8C24]">
                  توافق بالذكاء الاصطناعي بين طلبات العملاء والعقارات
                </span>
              </li>
              <li className="flex items-start gap-3 transition-all duration-500 hover:translate-x-2">
                <svg
          ...
          {/* الباقة الخاصة */}
          <div
            className={`bg-white border-2 border-gray-200 rounded-lg p-8 relative transition-all duration-500 delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            {/* Icon */}
            ...
            <div className="mb-8">
              <p className="text-center text-gray-700 text-lg leading-relaxed">
                حلول مخصصة تناسب احتياجات عملك بشكل كامل. نقوم بتطوير ميزات خاصة
                وتكاملات متقدمة حسب متطلباتك.
              </p>
            </div>
            ...
            <ul className="space-y-4 mb-8">
              ...
              <li className="flex items-start gap-3 transition-all duration-500 hover:translate-x-2">
                ...
                <span className="text-gray-700 transition-all duration-500 hover:text-[#FF8C24]">
                  تكاملات متقدمة مع أنظمتك الحالية
                </span>
              </li>
              <li className="flex items-start gap-3 transition-all duration-500 hover:translate-x-2">
                <svg
