  ...
  return (
    <section id="features-wp" className="py-20 bg-white relative">
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16  pb-[5rem]">
          <h2 className="text-3xl lg:text-5xl font-bold text-black mb-8 leading-tight">
            ...
            <span className="ui-e-headline-text ui-e-headline-stroke7">
              ...
              <span>
                <span className="ui-e-headline-text ui-e-headline-highlighted relative z-10 text-[#17BD37]">
                  للعقارات
                </span>
              </span>
              <span className="whitespace"> </span>
        ...
        <div className="relative min-h-[500px] sm:min-h-[600px] md:min-h-[700px] lg:min-h-[800px] aspect-auto sm:aspect-auto mt-[10rem]">
          ...
          ></div>
          <div
            className={`flex justify-center mt-[7rem] transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div
              className={`absolute -mt-[6rem] sm:mt-0 sm:-top-[3rem] md:-top-[5rem] left-0 right-0 flex justify-center transition-all duration-1000 delay-200 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-75"}`}
            >
            ...
            <div
              className={`absolute top-12 sm:top-16 md:top-[7rem] -right-3 sm:right-5 md:-right-[5rem] lg:-right-[5rem] xl:right-[10rem] transition-all duration-1000 delay-300 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-75"}`}
            >
              <div className="flex flex-col items-center gap-4 p-4">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg order-1 sm:order-0">
                  <svg
                    className="w-6 h-6 md:w-8 md:h-8 text-white"
                    fill="currentColor"
                    viewBox="0 0 24 24"
            ...
            <div
              className={`absolute top-12 sm:top-16 md:top-[7rem] -left-3 sm:left-6 md:-left-[5rem] lg:-left-[5rem]  xl:left-[10rem] transition-all duration-1000 delay-400 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-75"}`}
            >
              <div className="flex flex-col items-center gap-4 p-4">
            ...
            {/* AI Matching Feature - Bottom Right */}
            <div
              className={`absolute bottom-12 sm:bottom-[8rem] md:bottom-[15rem] -right-3 sm:right-5 md:-right-[5rem] lg:-right-[5rem] xl:right-[10rem] transition-all duration-1000 delay-500 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-75"}`}
            >
              <div className="flex flex-col items-center gap-4 p-4">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-[#6366F1] rounded-full flex items-center justify-center shadow-lg">
                  <Bot className="w-6 h-6 md:w-8 md:h-8 text-white" />
                </div>
                <div className="max-w-[85px] sm:max-w-[150px] text-right">
                  <h4 className="text-xs md:text-sm font-semibold text-black">
                    ربط العروض وطلبات العملاء تلقائيًا بالذكاء الصناعي
                  </h4>
                </div>
              </div>
            </div>
            ...
            <div
              className={`absolute bottom-12 sm:bottom-[8rem] md:bottom-[15rem] -left-3 sm:left-6 md:-left-[5rem] lg:-left-[5rem] xl:left-[10rem] transition-all duration-1000 delay-600 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-75"}`}
            >
              <div className="flex flex-col items-center gap-4 p-4">
            ...
            <div
              className={`absolute top-6 sm:top-8 md:top-10 left-6 sm:left-12 md:left-20 transition-all duration-1000 -z-5 delay-700 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-75"} hidden sm:block`}
            >
              <img
            ...
            <div
              className={`absolute top-20 sm:top-24 md:top-32 right-10 sm:right-16 md:right-32 transition-all duration-1000 delay-800 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-75"} hidden sm:block`}
            >
              <img
            ...
            <div
              className={`absolute bottom-20 sm:bottom-24 md:bottom-32 left-10 sm:left-16 md:left-32 transition-all duration-1000 delay-900 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-75"} hidden sm:block`}
            >
              <img
            ...
            <div
              className={`absolute bottom-6 sm:bottom-8 md:bottom-10 right-6 sm:right-12 md:right-20 transition-all duration-1000 delay-1000 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-75"} hidden sm:block`}
            >
              <img
            ...
            <div
              className={`absolute top-1/2 right-6 sm:right-12 md:right-20 transform -translate-y-1/2 transition-all duration-1000 delay-1100 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-75"} hidden sm:block`}
            >
              <img
