...
export function OwnersPage() {
  ...
  const [isAssignPropertiesDialogOpen, setIsAssignPropertiesDialogOpen] = useState(false);
  ...
  const [selectedOwnerForDelete, setSelectedOwnerForDelete] = useState<Owner | null>(null);
  ...
  const handleAssignProperties = async () => {
    ...
    if (result.success) {
      ...
      if (selectedOwnerDetails && selectedOwnerDetails.id === selectedOwnerForAssign.id) {
  ...
  const filteredProperties = Array.isArray(availableProperties) 
    ? availableProperties.filter((property: any) =>
  ...
  const handleUpdateOwner = async () => {
    ...
    const result = await updateOwnerRental(selectedOwnerForEdit.id, editFormData);
  ...
  const handleChangePassword = async () => {
    ...
    const result = await changeOwnerPassword(selectedOwnerForEdit.id, passwordData.password);
  ...
  return (
    <div className="flex min-h-screen flex-col" dir="rtl">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <Select
          value={statusFilter}
          onValueChange={(v) => setRentalOwnerDashboard({ statusFilter: v })}
        >
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {owners.reduce((sum: number, o: Owner) => sum + (o.properties?.length || 0), 0)}
                </p>
              </div>
                      ...
                      <td className="px-6 py-5">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end" className="text-right">
                            ...
                            <DropdownMenuItem
                              onClick={() => openAssignPropertiesDialog(owner)}
                              className="cursor-pointer"
                            >
                            ...
                            <DropdownMenuItem
                              onClick={() => openViewPropertiesDialog(owner)}
                              className="cursor-pointer"
                            >
        ...
        <DialogContent className="max-w-2xl" dir="rtl">
          ...
          {loadingOwnerDetails ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <Button onClick={() => selectedOwnerDetails && fetchOwnerDetails(selectedOwnerDetails.id)}>
                إعادة المحاولة
              </Button>
            </div>
          ) : selectedOwnerDetails && (
            <div className="space-y-6">
              ...
              <div>
                <h4 className="text-lg font-bold text-gray-900 mb-3 flex items-center gap-2">
                  ...
                  العقارات ({selectedOwnerDetails.properties?.length || 0})
                </h4>
                {selectedOwnerDetails.properties && selectedOwnerDetails.properties.length > 0 ? (
                  <div className="space-y-2 max-h-60 overflow-y-auto">
                    {selectedOwnerDetails.properties.map((property: Property) => (
                      <div
                        key={property.id}
      ...
      <Dialog open={isAssignPropertiesDialogOpen} onOpenChange={closeAssignPropertiesDialog}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto" dir="rtl">
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedOwnerForAssign && (
                <span>
                  ربط عقارات بـ <strong>{selectedOwnerForAssign.name}</strong>
                </span>
              )}
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter className="gap-2 sm:gap-0">
            ...
            <Button
              ...
              disabled={assigningProperties || selectedPropertyIds.length === 0}
              className="gap-2"
            >
              {assigningProperties ? (
                <>
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedOwnerForEdit && (
                <span>تعديل بيانات <strong>{selectedOwnerForEdit.name}</strong></span>
              )}
            </DialogDescription>
          </DialogHeader>
                      ...
                      <div className="p-0">
                        ...
                        {property.featured_image_url && (
                          <div className="relative h-48 w-full">
                            <img
                              src={property.featured_image_url}
                              alt={property.contents?.[0]?.title || `عقار ${property.id}`}
                        ...
                        <div className="p-4 space-y-3">
                          ...
                          <div>
                            ...
                            {property.category && (
                              <p className="text-sm text-gray-500">{property.category.name}</p>
                            )}
                          </div>
                          ...
                          {property.contents?.[0]?.address && (
                            <div className="flex items-start gap-2 text-sm text-gray-500">
                              ...
                              <span className="line-clamp-2">{property.contents[0].address}</span>
                            </div>
                          )}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleCreateFormChange("id_number", e.target.value)}
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              <div className="space-y-0.5">
                <Label>حالة الحساب</Label>
                <p className="text-sm text-muted-foreground">
                  {createFormData.is_active ? "الحساب نشط" : "الحساب غير نشط"}
                </p>
              </div>
              <Switch
                checked={createFormData.is_active}
                onCheckedChange={(checked) => handleCreateFormChange("is_active", checked)}
              />
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 flex items-start gap-2">
                ...
                <div className="text-sm text-yellow-800">
                  ...
                  <p>سيتم حذف جميع البيانات المرتبطة بهذا المالك بشكل نهائي</p>
                </div>
              </div>
            </div>
          )}
