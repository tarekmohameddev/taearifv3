...
import { Menu, X, Globe, Users, Phone, Play } from 'lucide-react';
      ...
      <header className="fixed top-0 z-50 w-full border-b border-gray-100 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-sm">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="/solutions" className="text-sm font-medium text-black border-b-2 border-purple-500">الحلول</a>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <button onClick={toggleMobileMenu} className="md:hidden p-2 text-slate-700">
      ...
      <div className={`fixed inset-0 bg-white/95 backdrop-blur-md z-50 transition-all duration-300 transform ${isMobileMenuOpen ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'} md:hidden`}>
        <div className="container h-full flex flex-col py-6">
          <div className="flex justify-between items-center mb-8">
            ...
            <button onClick={toggleMobileMenu} className="p-2 text-slate-700">
              <X className="h-5 w-5" />
            </button>
          </div>
          <nav className="flex flex-col gap-4 text-right">
            ...
            <a href="/solutions" className="text-lg font-medium py-3 px-4 rounded-lg bg-purple-50 text-purple-700">الحلول</a>
