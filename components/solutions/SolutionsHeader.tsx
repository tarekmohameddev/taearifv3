...
export default function SolutionsHeader() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed inset-0 bg-white/95 backdrop-blur-md z-50 transition-all duration-300 transform ${isMobileMenuOpen ? "translate-x-0 opacity-100" : "translate-x-full opacity-0"} md:hidden`}
      >
