    ...
    <>
      ...
      <Dialog open={showStageDialog} onOpenChange={setShowStageDialog}>
        <DialogContent dir="rtl">
          <DialogHeader>
            <DialogTitle>تغيير المرحلة - {selectedIds.length} عميل</DialogTitle>
            <DialogDescription>
      ...
      <Dialog open={showPriorityDialog} onOpenChange={setShowPriorityDialog}>
        <DialogContent dir="rtl">
          <DialogHeader>
            <DialogTitle>تغيير الأولوية - {selectedIds.length} عميل</DialogTitle>
            <DialogDescription>
      ...
      <Dialog open={showTagDialog} onOpenChange={setShowTagDialog}>
        <DialogContent dir="rtl">
          <DialogHeader>
            <DialogTitle>إضافة وسوم - {selectedIds.length} عميل</DialogTitle>
            <DialogDescription>
      ...
      <Dialog open={showEmailDialog} onOpenChange={setShowEmailDialog}>
        <DialogContent dir="rtl" className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>إرسال بريد إلكتروني - {selectedIds.length} عميل</DialogTitle>
            <DialogDescription>
      ...
      <Dialog open={showAssignDialog} onOpenChange={setShowAssignDialog}>
        <DialogContent dir="rtl">
          <DialogHeader>
            <DialogTitle>تعيين موظف - {selectedIds.length} عميل</DialogTitle>
            <DialogDescription>
