        ...
        <div className="mx-auto w-full max-w-9xl px-4 relative z-10">
          ...
          <div className="mx-auto max-w-7xl rounded-2xl px-6 py-10 shadow-md sm:px-10 sm:py-12 bg-emerald-200 relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-200 via-emerald-100 to-emerald-200">
              ...
              <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-200/30 to-transparent animate-shimmer" style={{ animationDelay: '1s' }}></div>
            </div>

            <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-12 relative z-10" dir="rtl">
              ...
              <div className="order-1 mx-auto md:order-1 md:col-span-5 md:justify-self-start w-32 md:w-[20rem] lg:w-[20rem]">
                ...
                <div className="w-full bg-white/20 rounded-lg animate-pulse relative overflow-hidden" style={{ aspectRatio: "2/1" }}>
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-white/20 via-white/10 to-white/20">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/20 to-transparent animate-shimmer" style={{ animationDelay: '1.2s' }}></div>
                  </div>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 bg-white/30 rounded-lg animate-pulse relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/50 to-transparent animate-shimmer" style={{ animationDelay: '0.3s' }}></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="order-2 text-center md:order-2 md:col-span-7 md:text-center">
                ...
                <div className="mb-2 space-y-2">
                  ...
                  <div className="h-5 md:h-6 bg-white/20 rounded animate-pulse mx-auto w-full max-w-md relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/50 to-transparent animate-shimmer" style={{ animationDelay: '0.5s' }}></div>
                    <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/25 to-transparent animate-shimmer" style={{ animationDelay: '1.5s' }}></div>
                  </div>
                ...
                <div className="mb-6">
                  <div className="h-5 md:h-6 bg-white/20 rounded animate-pulse mx-auto w-24 md:w-32 relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/50 to-transparent animate-shimmer" style={{ animationDelay: '0.7s' }}></div>
                    <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/25 to-transparent animate-shimmer" style={{ animationDelay: '1.7s' }}></div>
                  </div>
                </div>
                ...
                <div className="mt-6">
                  <div className="inline-block bg-white/90 rounded-xl px-6 py-5 animate-pulse relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent animate-shimmer" style={{ animationDelay: '0.8s' }}></div>
                    <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/20 to-transparent animate-shimmer" style={{ animationDelay: '1.8s' }}></div>
                    
                    {/* Button Text Skeleton */}
                    <div className="h-4 md:h-5 bg-emerald-200 rounded animate-pulse w-20 md:w-24 relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-300/60 to-transparent animate-shimmer" style={{ animationDelay: '0.9s' }}></div>
                      <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-200/40 to-transparent animate-shimmer" style={{ animationDelay: '1.9s' }}></div>
                    </div>
                  </div>
                </div>
              </div>
