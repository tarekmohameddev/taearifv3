      ...
      <div className="relative">
        ...
        <div className="relative z-10 w-full">
          ...
          <div className="w-[80%] mb-[20px] md:w-fit md:mx-0 flex items-center justify-center mx-auto">
            <div className="w-full md:w-auto bg-emerald-200 rounded-[10px] px-[20px] py-[8px] animate-pulse relative overflow-hidden">
              {/* Button Text Skeleton - "طلب معاينة" */}
              <div className="h-3 md:h-4 lg:h-5 bg-emerald-300 rounded animate-pulse w-16 md:w-20 lg:w-24 relative overflow-hidden">
          ...
          <div className="filterButtons mb-6 flex items-center justify-center md:justify-start gap-x-[24px]">
            ...
            <div className="w-fit bg-emerald-200 rounded-[10px] px-[20px] py-[8px] animate-pulse relative overflow-hidden">
              <div className="h-3 md:h-4 lg:h-5 bg-emerald-300 rounded animate-pulse w-8 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-400/70 to-transparent animate-shimmer" style={{ animationDelay: '0.2s' }}></div>
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-300/40 to-transparent animate-shimmer" style={{ animationDelay: '1.2s' }}></div>
              </div>
            </div>
