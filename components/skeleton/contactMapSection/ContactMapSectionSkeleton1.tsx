...
export default function ContactMapSectionSkeleton1() {
  console.log("🎨 ContactMapSectionSkeleton1: Component is rendering!");
          ...
          <header className="mb-10 text-right">
            ...
            <div className="max-w-4xl leading-7 mt-4 space-y-2">
              ...
              <div className="h-5 md:h-6 bg-gray-100 rounded animate-pulse w-4/5 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-200/50 to-transparent animate-shimmer" style={{ animationDelay: '0.4s' }}></div>
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-100/30 to-transparent animate-shimmer" style={{ animationDelay: '1.4s' }}></div>
              </div>
            </div>
          </header>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="min-h-[120px] bg-gray-100 border border-gray-200 rounded-md animate-pulse relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-200/50 to-transparent animate-shimmer" style={{ animationDelay: '1.0s' }}></div>
                    <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-100/30 to-transparent animate-shimmer" style={{ animationDelay: '2.0s' }}></div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {Array.from({ length: 5 }).map((_, i) => (
                      <div key={i} className={`w-8 h-8 rounded animate-pulse relative overflow-hidden ${
                        i < 3 ? 'bg-yellow-200' : 'bg-gray-200'
                      }`}>
                        <div className={`absolute inset-0 bg-gradient-to-r from-transparent ${
                          i < 3 ? 'via-yellow-300/60' : 'via-gray-300/60'
                        } to-transparent animate-shimmer`} style={{ animationDelay: `${1.2 + i * 0.1}s` }}></div>
                        <div className={`absolute inset-0 bg-gradient-to-l from-transparent ${
                          i < 3 ? 'via-yellow-200/40' : 'via-gray-200/40'
                        } to-transparent animate-shimmer`} style={{ animationDelay: `${2.2 + i * 0.1}s` }}></div>
                      </div>
                    ))}
                    ...
                    <div className="mr-2">
                      <div className="h-4 bg-gray-200 rounded animate-pulse w-8 relative overflow-hidden">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/40 to-transparent animate-shimmer" style={{ animationDelay: '2.7s' }}></div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="order-2 lg:order-2">
              <div className="h-[400px] lg:h-[500px] w-full overflow-hidden rounded-xl border bg-gray-200 animate-pulse relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-gray-200 via-gray-100 to-gray-200">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/50 to-transparent animate-shimmer" style={{ animationDelay: '2.0s' }}></div>
                  <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/30 to-transparent animate-shimmer" style={{ animationDelay: '3.0s' }}></div>
                </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  <div className="relative">
                    ...
                    <div className="w-8 h-8 bg-red-200 rounded-full animate-pulse relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-red-300/60 to-transparent animate-shimmer" style={{ animationDelay: '2.1s' }}></div>
                      <div className="absolute inset-0 bg-gradient-to-l from-transparent via-red-200/40 to-transparent animate-shimmer" style={{ animationDelay: '3.1s' }}></div>
                    </div>
                ...
                <div className="absolute top-4 right-4 space-y-2">
                  ...
                  <div className="w-8 h-8 bg-white border border-gray-300 rounded animate-pulse relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-100/40 to-transparent animate-shimmer" style={{ animationDelay: '2.2s' }}></div>
                  </div>
                  
                  {/* Zoom Out Button */}
                  <div className="w-8 h-8 bg-white border border-gray-300 rounded animate-pulse relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-100/40 to-transparent animate-shimmer" style={{ animationDelay: '2.3s' }}></div>
                  </div>
                </div>
                ...
                <div className="absolute bottom-4 right-4 space-y-1">
                  ...
                  <div className="w-10 h-8 bg-white border border-gray-300 rounded animate-pulse relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-100/40 to-transparent animate-shimmer" style={{ animationDelay: '2.4s' }}></div>
                  </div>
                  
                  {/* Fullscreen Button */}
                  <div className="w-8 h-8 bg-white border border-gray-300 rounded animate-pulse relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-100/40 to-transparent animate-shimmer" style={{ animationDelay: '2.5s' }}></div>
                  </div>
                </div>
                ...
                <div className="absolute bottom-4 left-4">
                  <div className="w-16 h-6 bg-white border border-gray-300 rounded animate-pulse relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-100/40 to-transparent animate-shimmer" style={{ animationDelay: '2.6s' }}></div>
                  </div>
                </div>
                ...
                <div className="absolute top-4 left-4">
                  <div className="flex items-center space-x-2 bg-white/90 px-3 py-2 rounded-lg shadow-sm">
                    ...
                    <div className="h-3 w-16 bg-gray-200 rounded animate-pulse relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/60 to-transparent animate-shimmer" style={{ animationDelay: '2.7s' }}></div>
                    </div>
                  </div>
                </div>
              </div>
