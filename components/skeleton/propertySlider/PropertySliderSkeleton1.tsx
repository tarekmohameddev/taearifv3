...
export default function PropertySliderSkeleton1() {
  console.log("🎨 PropertySliderSkeleton1: Component is rendering!");
        ...
        <div className="mb-6 px-5" dir="rtl" style={{ marginBottom: "24px" }}>
          ...
          <div className="flex items-center justify-between md:hidden">
            ...
            <div className="h-4 bg-emerald-100 rounded animate-pulse w-16 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-200/60 to-transparent animate-shimmer" style={{ animationDelay: '0.2s' }}></div>
              <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-100/40 to-transparent animate-shimmer" style={{ animationDelay: '1.2s' }}></div>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-end justify-between">
            ...
            <div className="h-4 bg-emerald-100 rounded animate-pulse w-16 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-200/60 to-transparent animate-shimmer" style={{ animationDelay: '0.5s' }}></div>
              <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-100/40 to-transparent animate-shimmer" style={{ animationDelay: '1.5s' }}></div>
            </div>
          </div>
                  ...
                  <div className="h-full w-full">
                    ...
                    <div className="relative w-full bg-gray-200 rounded-xl animate-pulse overflow-hidden" style={{ aspectRatio: "16 / 10" }}>
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-gray-200 via-gray-100 to-gray-200">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/50 to-transparent animate-shimmer" style={{ animationDelay: `${0.8 + index * 0.1}s` }}></div>
                        <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/30 to-transparent animate-shimmer" style={{ animationDelay: `${1.8 + index * 0.1}s` }}></div>
                      </div>
                      ...
                      <div className="absolute right-3 top-3 flex items-center gap-2 rounded-lg bg-white/95 px-3 py-2 shadow-sm">
                        ...
                        <div className="flex items-center gap-1">
                          <div className="w-4 h-4 bg-emerald-200 rounded animate-pulse relative overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-300/60 to-transparent animate-shimmer" style={{ animationDelay: `${0.9 + index * 0.1}s` }}></div>
                          </div>
                        ...
                        <div className="flex items-center gap-1">
                          <div className="h-4 w-6 bg-gray-200 rounded animate-pulse relative overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/60 to-transparent animate-shimmer" style={{ animationDelay: `${1.1 + index * 0.1}s` }}></div>
                          </div>
                          <div className="w-4 h-4 bg-gray-200 rounded animate-pulse relative overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/60 to-transparent animate-shimmer" style={{ animationDelay: `${1.2 + index * 0.1}s` }}></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 space-y-3" dir="rtl">
                      ...
                      <div className="space-y-2">
                        <div className="h-5 bg-gray-200 rounded animate-pulse w-full relative overflow-hidden">
                          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/60 to-transparent animate-shimmer" style={{ animationDelay: `${1.3 + index * 0.1}s` }}></div>
                          <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/40 to-transparent animate-shimmer" style={{ animationDelay: `${2.3 + index * 0.1}s` }}></div>
                        </div>
                        <div className="h-5 bg-gray-200 rounded animate-pulse w-3/4 relative overflow-hidden">
                          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/60 to-transparent animate-shimmer" style={{ animationDelay: `${1.4 + index * 0.1}s` }}></div>
                          <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/40 to-transparent animate-shimmer" style={{ animationDelay: `${2.4 + index * 0.1}s` }}></div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-1">
                        <div className="h-4 bg-gray-100 rounded animate-pulse w-5/6 relative overflow-hidden">
                          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-200/50 to-transparent animate-shimmer" style={{ animationDelay: `${1.5 + index * 0.1}s` }}></div>
                          <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-100/30 to-transparent animate-shimmer" style={{ animationDelay: `${2.5 + index * 0.1}s` }}></div>
                        </div>
                        <div className="h-4 bg-gray-100 rounded animate-pulse w-4/6 relative overflow-hidden">
                          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-200/50 to-transparent animate-shimmer" style={{ animationDelay: `${1.6 + index * 0.1}s` }}></div>
                          <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-100/30 to-transparent animate-shimmer" style={{ animationDelay: `${2.6 + index * 0.1}s` }}></div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="h-5 bg-gray-200 rounded animate-pulse w-24 relative overflow-hidden">
                          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/60 to-transparent animate-shimmer" style={{ animationDelay: `${1.7 + index * 0.1}s` }}></div>
                          <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/40 to-transparent animate-shimmer" style={{ animationDelay: `${2.7 + index * 0.1}s` }}></div>
                        </div>
                        
                        {/* Details Button Skeleton */}
                        <div className="h-4 bg-emerald-100 rounded animate-pulse w-12 relative overflow-hidden">
                          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-200/60 to-transparent animate-shimmer" style={{ animationDelay: `${1.8 + index * 0.1}s` }}></div>
                          <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-100/40 to-transparent animate-shimmer" style={{ animationDelay: `${2.8 + index * 0.1}s` }}></div>
                        </div>
                      </div>
                    </div>
                  </div>
