    ...
    >
      <div className="flex flex-col gap-[12px] md:gap-x-[30px] lg:gap-x-[74px] md:flex-row-reverse">
        ...
        <div className="md:flex-[.6] xl:flex-[.72] flex flex-col justify-center order-2 md:order-1">
          ...
          <div 
            className="transition-colors duration-300 flex items-center justify-center w-[119px] md:w-[148px] h-[46px] md:h-[52px] rounded-[10px] bg-emerald-200 animate-pulse relative overflow-hidden"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-300/60 to-transparent animate-shimmer" style={{ animationDelay: '1.1s' }}></div>
            <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-200/40 to-transparent animate-shimmer" style={{ animationDelay: '2.1s' }}></div>
          </div>
        </div>
        ...
        >
          ...
          <div 
            className="absolute top-0 left-0 h-full overflow-hidden z-0 rounded-[5px] w-[54%] md:w-1/2 bg-emerald-600 animate-pulse"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-700/30 to-transparent animate-shimmer" style={{ animationDelay: '1.2s' }}></div>
            <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-500/20 to-transparent animate-shimmer" style={{ animationDelay: '2.2s' }}></div>
          </div>
          ...
          <div className="w-full h-full bg-gray-200 rounded-[5px] animate-pulse relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-gray-200 via-gray-100 to-gray-200">
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/50 to-transparent animate-shimmer" style={{ animationDelay: '1.3s' }}></div>
              <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/30 to-transparent animate-shimmer" style={{ animationDelay: '2.3s' }}></div>
            </div>

            {/* Image Placeholder Icon */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-16 h-16 md:w-20 md:h-20 bg-gray-300 rounded-full animate-pulse relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-400/50 to-transparent animate-shimmer" style={{ animationDelay: '1.4s' }}></div>
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-300/30 to-transparent animate-shimmer" style={{ animationDelay: '2.4s' }}></div>
              </div>
            </div>
