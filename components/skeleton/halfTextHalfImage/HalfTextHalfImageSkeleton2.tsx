      ...
      >
        ...
        <div className="md:col-span-5 order-2 md:order-2">
          ...
          <div className="mb-3">
            <div className="h-6 md:h-7 bg-emerald-100 rounded animate-pulse w-48 relative overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-100/40 to-transparent animate-shimmer" style={{ animationDelay: '1s' }}></div>
            </div>
          </div>
          ...
          <div className="grid text-center grid-cols-2 sm:grid-cols-4 gap-4 mt-10">
            ...
            <div>
              <div className="h-7 md:h-8 bg-emerald-100 rounded animate-pulse w-16 mx-auto relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-200/60 to-transparent animate-shimmer" style={{ animationDelay: '0.9s' }}></div>
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-100/40 to-transparent animate-shimmer" style={{ animationDelay: '1.9s' }}></div>
              </div>
              <div className="mt-1">
                <div className="h-5 md:h-6 bg-gray-200 rounded animate-pulse w-20 mx-auto relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/60 to-transparent animate-shimmer" style={{ animationDelay: '1.0s' }}></div>
                  <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/40 to-transparent animate-shimmer" style={{ animationDelay: '2.0s' }}></div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="h-7 md:h-8 bg-emerald-100 rounded animate-pulse w-12 mx-auto relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-200/60 to-transparent animate-shimmer" style={{ animationDelay: '1.1s' }}></div>
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-100/40 to-transparent animate-shimmer" style={{ animationDelay: '2.1s' }}></div>
              </div>
              <div className="mt-1">
                <div className="h-5 md:h-6 bg-gray-200 rounded animate-pulse w-24 mx-auto relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/60 to-transparent animate-shimmer" style={{ animationDelay: '1.2s' }}></div>
                  <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/40 to-transparent animate-shimmer" style={{ animationDelay: '2.2s' }}></div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="h-7 md:h-8 bg-emerald-100 rounded animate-pulse w-16 mx-auto relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-200/60 to-transparent animate-shimmer" style={{ animationDelay: '1.3s' }}></div>
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-100/40 to-transparent animate-shimmer" style={{ animationDelay: '2.3s' }}></div>
              </div>
              <div className="mt-1">
                <div className="h-5 md:h-6 bg-gray-200 rounded animate-pulse w-28 mx-auto relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/60 to-transparent animate-shimmer" style={{ animationDelay: '1.4s' }}></div>
                  <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/40 to-transparent animate-shimmer" style={{ animationDelay: '2.4s' }}></div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="h-7 md:h-8 bg-emerald-100 rounded animate-pulse w-8 mx-auto relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-200/60 to-transparent animate-shimmer" style={{ animationDelay: '1.5s' }}></div>
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-100/40 to-transparent animate-shimmer" style={{ animationDelay: '2.5s' }}></div>
              </div>
              <div className="mt-1">
                <div className="h-5 md:h-6 bg-gray-200 rounded animate-pulse w-24 mx-auto relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/40 to-transparent animate-shimmer" style={{ animationDelay: '2.6s' }}></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="md:col-span-5 order-2 md:order-2">
          <figure className="relative flex-1 pr-[15px] xl:pr-[21px] pb-[15px] xl:pb-[21px] bg-emerald-600 rounded-[10px]">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-700/30 to-transparent animate-shimmer rounded-[10px]" style={{ animationDelay: '1.7s' }}></div>
            <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-500/20 to-transparent animate-shimmer rounded-[10px]" style={{ animationDelay: '2.7s' }}></div>

            {/* Main Image Skeleton */}
            <div className="w-full h-full bg-gray-200 rounded-[15px] animate-pulse relative overflow-hidden" style={{ aspectRatio: "800/600" }}>
              
              {/* Background Shimmer */}
              <div className="absolute inset-0 bg-gradient-to-br from-gray-200 via-gray-100 to-gray-200">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/50 to-transparent animate-shimmer" style={{ animationDelay: '1.8s' }}></div>
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/30 to-transparent animate-shimmer" style={{ animationDelay: '2.8s' }}></div>
              </div>

              {/* Image Placeholder Icon */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-20 h-20 md:w-24 md:h-24 bg-gray-300 rounded-full animate-pulse relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-400/50 to-transparent animate-shimmer" style={{ animationDelay: '1.9s' }}></div>
                  <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-300/30 to-transparent animate-shimmer" style={{ animationDelay: '2.9s' }}></div>
                </div>
              </div>
