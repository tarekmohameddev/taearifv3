  ...
  return (
    ...
    >
             ...
             <div className="absolute inset-0 bg-gradient-to-br from-gray-200 via-gray-100 to-gray-200 animate-gentle-fade">
               ...
               <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/20 to-transparent animate-shimmer-slow" style={{ animationDelay: '2s' }}></div>
             </div>
        ...
        <div className="hidden md:block" style={{ paddingTop: "200px" }}>
          ...
          <div className="mx-auto max-w-5xl space-y-4">
                   <div className="h-12 lg:h-16 bg-white/25 rounded-lg animate-breathing mx-auto w-4/5 relative overflow-hidden">
                     ...
                     <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/30 to-transparent animate-shimmer-slow" style={{ animationDelay: '2.5s' }}></div>
                   </div>
            <div className="h-12 lg:h-16 bg-white/25 rounded-lg animate-gentle-fade mx-auto w-full relative overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/30 to-transparent animate-shimmer-ultra" style={{ animationDelay: '3s' }}></div>
            </div>
            <div className="h-12 lg:h-16 bg-white/25 rounded-lg animate-breathing mx-auto w-3/5 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/60 to-transparent animate-shimmer-ultra" style={{ animationDelay: '1.5s' }}></div>
              <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/30 to-transparent animate-shimmer-slow" style={{ animationDelay: '3.5s' }}></div>
            </div>
          </div>
          ...
          <div className="mt-4 space-y-2">
            <div className="h-6 lg:h-8 bg-white/20 rounded-lg animate-gentle-fade mx-auto w-3/4 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/50 to-transparent animate-shimmer-slow" style={{ animationDelay: '2s' }}></div>
              <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/25 to-transparent animate-shimmer-ultra" style={{ animationDelay: '4s' }}></div>
            </div>
            <div className="h-6 lg:h-8 bg-white/20 rounded-lg animate-breathing mx-auto w-2/3 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/50 to-transparent animate-shimmer-ultra" style={{ animationDelay: '2.5s' }}></div>
              <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/25 to-transparent animate-shimmer-slow" style={{ animationDelay: '4.5s' }}></div>
            </div>
          </div>
        </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center">
            ...
            <div className="mx-auto max-w-sm space-y-3 mb-4">
              <div className="h-8 bg-white/25 rounded-lg animate-pulse w-full relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/30 to-transparent animate-shimmer" style={{ animationDelay: '1s' }}></div>
              </div>
              <div className="h-8 bg-white/25 rounded-lg animate-pulse w-4/5 mx-auto relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/30 to-transparent animate-shimmer" style={{ animationDelay: '1.2s' }}></div>
              </div>
              <div className="h-8 bg-white/25 rounded-lg animate-pulse w-3/5 mx-auto relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/30 to-transparent animate-shimmer" style={{ animationDelay: '1.4s' }}></div>
              </div>
            </div>
            ...
            <div className="mb-8 space-y-2 max-w-xs">
              <div className="h-5 bg-white/20 rounded-lg animate-pulse w-full relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/25 to-transparent animate-shimmer" style={{ animationDelay: '1.6s' }}></div>
              </div>
              <div className="h-5 bg-white/20 rounded-lg animate-pulse w-4/5 mx-auto relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/50 to-transparent animate-shimmer" style={{ animationDelay: '0.8s' }}></div>
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-white/25 to-transparent animate-shimmer" style={{ animationDelay: '1.8s' }}></div>
              </div>
            </div>
          </div>
            ...
            <div className="w-full rounded-lg bg-white p-3 shadow-2xl ring-1 ring-black/5 space-y-4">
              ...
              <div className="flex justify-center">
                <div className="inline-flex overflow-hidden rounded-xl border bg-gray-50 p-1 gap-1">
                  <div className="h-8 w-16 bg-emerald-200 rounded-lg animate-pulse relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-300/40 to-transparent animate-shimmer" style={{ animationDelay: '1s' }}></div>
                  </div>
                  <div className="h-8 w-16 bg-gray-200 rounded-lg animate-pulse relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-400/70 to-transparent animate-shimmer" style={{ animationDelay: '0.3s' }}></div>
                    <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-300/40 to-transparent animate-shimmer" style={{ animationDelay: '1.3s' }}></div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="h-12 bg-gray-100 rounded-lg animate-pulse relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-400/70 to-transparent animate-shimmer" style={{ animationDelay: '0.1s' }}></div>
                  <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-300/40 to-transparent animate-shimmer" style={{ animationDelay: '1.1s' }}></div>
                </div>
                <div className="h-12 bg-gray-100 rounded-lg animate-pulse relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-400/70 to-transparent animate-shimmer" style={{ animationDelay: '0.2s' }}></div>
                ...
                <div className="h-12 bg-gray-100 rounded-lg animate-pulse relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-400/70 to-transparent animate-shimmer" style={{ animationDelay: '0.4s' }}></div>
                ...
                <div className="h-12 bg-emerald-200 rounded-lg animate-pulse relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-400/70 to-transparent animate-shimmer" style={{ animationDelay: '0.5s' }}></div>
                  <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-300/40 to-transparent animate-shimmer" style={{ animationDelay: '1.5s' }}></div>
                </div>
              </div>
            </div>
          </div>
