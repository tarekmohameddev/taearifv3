          ...
          <div className="block md:hidden px-4">
            ...
            <div className="flex justify-center items-center gap-2 mt-8">
              <div className="w-8 h-3 bg-emerald-200 rounded-md animate-pulse relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-300/60 to-transparent animate-shimmer" style={{ animationDelay: '1.5s' }}></div>
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-200/40 to-transparent animate-shimmer" style={{ animationDelay: '2.5s' }}></div>
              </div>
              <div className="w-3 h-3 bg-gray-200 rounded-full animate-pulse relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/50 to-transparent animate-shimmer" style={{ animationDelay: '1.6s' }}></div>
              </div>
              <div className="w-3 h-3 bg-gray-200 rounded-full animate-pulse relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/50 to-transparent animate-shimmer" style={{ animationDelay: '1.7s' }}></div>
              </div>
              <div className="w-3 h-3 bg-gray-200 rounded-full animate-pulse relative overflow-hidden">
  ...
  return (
    <div className="flex h-full w-full items-center justify-center p-4">
      ...
      <div className="relative flex w-full max-w-xl flex-col rounded-2xl border bg-white p-6 shadow-sm ring-1 ring-black/5 h-[200px]">
        ...
        {/* Quote Icon Skeleton */}
        <div 
          className="absolute h-[27px] w-[34px] z-20 top-[-15px] left-0 flex justify-center items-center bg-emerald-100 rounded animate-pulse relative overflow-hidden"
        >
        ...
        <div className="space-y-2 mb-4">
          <div className="h-4 bg-gray-100 rounded animate-pulse w-full relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-200/50 to-transparent animate-shimmer" style={{ animationDelay: `${delay + 0.5}s` }}></div>
            <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-100/30 to-transparent animate-shimmer" style={{ animationDelay: `${delay + 1.5}s` }}></div>
          </div>
        ...
        <div className="mt-auto flex items-center justify-between pt-3">
          ...
          <div className="text-end space-y-1">
            ...
            <div className="h-4 bg-gray-200 rounded animate-pulse w-24 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/60 to-transparent animate-shimmer" style={{ animationDelay: `${delay + 0.8}s` }}></div>
              <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/40 to-transparent animate-shimmer" style={{ animationDelay: `${delay + 1.8}s` }}></div>
            </div>
            {/* Location */}
