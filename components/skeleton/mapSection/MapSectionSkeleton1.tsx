...
export default function MapSectionSkeleton1() {
  console.log("🎨 MapSectionSkeleton1: Component is rendering!");
          ...
          <div className="w-full max-w-[1600px] mx-auto">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-gray-200 via-gray-100 to-gray-200">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/50 to-transparent animate-shimmer" style={{ animationDelay: '0.5s' }}></div>
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/30 to-transparent animate-shimmer" style={{ animationDelay: '1.5s' }}></div>
              </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div className="relative">
                  ...
                  <div className="w-8 h-8 bg-red-200 rounded-full animate-pulse relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-red-300/60 to-transparent animate-shimmer" style={{ animationDelay: '0.6s' }}></div>
                    <div className="absolute inset-0 bg-gradient-to-l from-transparent via-red-200/40 to-transparent animate-shimmer" style={{ animationDelay: '1.6s' }}></div>
                  </div>
              ...
              <div className="absolute top-4 right-4 space-y-2">
                ...
                <div className="w-8 h-8 bg-white border border-gray-300 rounded animate-pulse relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-100/40 to-transparent animate-shimmer" style={{ animationDelay: '0.7s' }}></div>
                </div>
                
                {/* Zoom Out Button */}
                <div className="w-8 h-8 bg-white border border-gray-300 rounded animate-pulse relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-100/40 to-transparent animate-shimmer" style={{ animationDelay: '0.8s' }}></div>
                </div>
              </div>
              ...
              <div className="absolute bottom-4 right-4 space-y-1">
                ...
                <div className="w-10 h-8 bg-white border border-gray-300 rounded animate-pulse relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-100/40 to-transparent animate-shimmer" style={{ animationDelay: '0.9s' }}></div>
                </div>
                
                {/* Fullscreen Button */}
                <div className="w-8 h-8 bg-white border border-gray-300 rounded animate-pulse relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-100/40 to-transparent animate-shimmer" style={{ animationDelay: '1.0s' }}></div>
                </div>
              </div>
              ...
              <div className="absolute bottom-4 left-4">
                <div className="w-16 h-6 bg-white border border-gray-300 rounded animate-pulse relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-100/40 to-transparent animate-shimmer" style={{ animationDelay: '1.1s' }}></div>
                </div>
              </div>
