    ...
    <div className="p-8 space-y-8 bg-gray-50 min-h-screen" dir="rtl">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="h-12 bg-gray-200 rounded-lg animate-enhanced-pulse relative overflow-hidden">
            <div
              className="absolute inset-0 bg-gradient-to-r from-transparent via-white/60 to-transparent animate-wave"
      ...
      <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
        ...
        <div className="text-sm text-blue-700 space-y-2">
          <p>
            <strong>animate-shimmer-ultra:</strong> الأنعم والأبطأ (5 ثواني) -
            للعناصر المهمة
          </p>
          <p>
            <strong>animate-shimmer-slow:</strong> بطيء ومتوسط (4 ثواني) -
            للمحتوى العادي
          </p>
          <p>
            <strong>animate-shimmer:</strong> عادي (3 ثواني) - للاستخدام العام
          </p>
          <p>
            <strong>animate-gentle-fade:</strong> تلاشي لطيف (2.5 ثانية) -
            للخلفيات
          </p>
          <p>
            <strong>animate-breathing:</strong> تنفس (3 ثواني) - للعناصر
            التفاعلية
          </p>
          <p>
            <strong>animate-wave:</strong> موجي (2.5 ثانية) - للتأثيرات الخاصة
          </p>
        </div>
      </div>
    </div>
