                ...
                <div className="w-full h-12 md:h-14 border border-gray-200 rounded-[10px] bg-white flex items-center px-2 pr-10 relative overflow-hidden">
                  ...
                  <div className="absolute left-2 md:left-4 top-1/2 transform -translate-y-1/2">
                    <div className="w-5 h-5 bg-gray-300 rounded animate-pulse relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-400/60 to-transparent animate-shimmer" style={{ animationDelay: '0.3s' }}></div>
                  ...
                  {Array.from({ length: 4 }).map((_, index) => (
                    <div key={index} className="px-4 py-3 border-b border-gray-100 last:border-b-0">
                      <div className={`h-4 bg-gray-200 rounded animate-pulse relative overflow-hidden ${
                        ...
                        <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/40 to-transparent animate-shimmer" style={{ animationDelay: `${1.4 + index * 0.1}s` }}></div>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <div className="w-full md:w-[23.86%] h-12 relative flex items-center justify-center py-2 border border-gray-200 md:h-14 rounded-[10px] bg-white overflow-hidden">
            ...
            <div className="w-full h-full flex items-center px-2">
              <div className="h-4 md:h-5 bg-gray-200 rounded animate-pulse w-2/5 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/60 to-transparent animate-shimmer" style={{ animationDelay: '0.8s' }}></div>
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gray-200/40 to-transparent animate-shimmer" style={{ animationDelay: '1.8s' }}></div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-[15.18%] h-full relative">
            <div className="flex items-center justify-center w-full h-12 md:h-14 bg-emerald-200 rounded-[10px] animate-pulse relative overflow-hidden">
              ...
              <div className="h-4 md:h-5 bg-emerald-300 rounded animate-pulse w-8 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-400/70 to-transparent animate-shimmer" style={{ animationDelay: '0.9s' }}></div>
                <div className="absolute inset-0 bg-gradient-to-l from-transparent via-emerald-300/40 to-transparent animate-shimmer" style={{ animationDelay: '1.9s' }}></div>
              </div>
            </div>
          </div>
        </form>
