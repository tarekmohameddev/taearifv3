      ...
      <header className="fixed top-0 z-50 w-full border-b border-gray-100 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="/updates" className="text-sm font-medium text-black border-b-2 border-purple-500">التحديثات</a>
        ...
        <div className="fixed inset-0 bg-white/95 backdrop-blur-md z-50 transition-all duration-300 md:hidden">
          <div className="max-w-6xl mx-auto px-4 h-full flex flex-col py-6">
            ...
            <nav className="flex flex-col gap-4 text-right">
              ...
              <a href="/updates" className="text-lg font-medium py-3 px-4 rounded-lg bg-purple-50 text-purple-700">التحديثات</a>
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-black">مميزات جديدة</span><br />
              <span className="bg-gradient-to-r from-black to-gray-600 bg-clip-text text-transparent">تطور مستمر</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              نعمل باستمرار على تطوير منصة تعاريف لتقديم أفضل تجربة لعملائنا في القطاع العقاري
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#latest-updates" className="inline-flex items-center bg-black text-white px-8 py-4 rounded-lg hover:bg-gray-800 transition-all text-lg">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              ...
              <span className="bg-gradient-to-r from-black to-gray-600 bg-clip-text text-transparent">الأخيرة</span>
            </h2>
            ...
            <div className="relative bg-white rounded-2xl p-8 border border-gray-200 hover:transform hover:-translate-y-2 transition-all duration-300 shadow-sm overflow-hidden">
              ...
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-green-600 font-medium">متاح الآن</div>
                </div>
              </div>
              <h3 className="font-bold text-xl mb-3">تحسين واجهة المستخدم</h3>
              <p className="text-gray-600 mb-4">واجهة أسرع وأسهل في الاستخدام مع تصميم محدث</p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm">UI/UX</span>
                <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm">تحسين الأداء</span>
              </div>
            </div>
            ...
            <div className="relative bg-white rounded-2xl p-8 border border-gray-200 hover:transform hover:-translate-y-2 transition-all duration-300 shadow-sm overflow-hidden">
              ...
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-blue-600 font-medium">متاح الآن</div>
                </div>
              </div>
              <h3 className="font-bold text-xl mb-3">ردود واتساب الذكية</h3>
              <p className="text-gray-600 mb-4">ردود آلية أكثر ذكاءً وتفاعلاً مع العملاء</p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">واتساب</span>
                <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">ذكاء اصطناعي</span>
              </div>
            </div>
            ...
            <div className="relative bg-white rounded-2xl p-8 border border-gray-200 hover:transform hover:-translate-y-2 transition-all duration-300 shadow-sm overflow-hidden">
              ...
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-purple-600 font-medium">متاح الآن</div>
                </div>
              </div>
              <h3 className="font-bold text-xl mb-3">تحسين قاعدة البيانات</h3>
              <p className="text-gray-600 mb-4">أداء أسرع وموثوقية أعلى في حفظ البيانات</p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm">قاعدة البيانات</span>
                <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm">الأداء</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              ...
              <span className="bg-gradient-to-r from-black to-gray-600 bg-clip-text text-transparent">جداً</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:transform hover:-translate-y-2 transition-all duration-300 shadow-sm">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <div className="text-sm text-purple-600 font-medium">متاح قريباً</div>
                </div>
              </div>
              <h3 className="font-bold text-2xl mb-4">جدولة الردود الآلية</h3>
              <p className="text-gray-600 mb-6 text-lg">برمج ردود واتساب لتصل في أوقات محددة وتفاعل مع العملاء بشكل أكثر احترافية</p>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:transform hover:-translate-y-2 transition-all duration-300 shadow-sm">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <div className="text-sm text-green-600 font-medium">قيد التطوير</div>
                </div>
              </div>
              <h3 className="font-bold text-2xl mb-4">تطبيق الجوال</h3>
              <p className="text-gray-600 mb-6 text-lg">تطبيق جوال متكامل لإدارة عقاراتك وعملائك من أي مكان</p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
                  <Check className="h-4 w-4 text-green-500 ml-2" />
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              ...
              <span className="bg-gradient-to-r from-black to-gray-600 bg-clip-text text-transparent">الطريق</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-12">
              ...
              <div className="relative pr-8">
                ...
                <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-xl">المرحلة الأولى - مكتملة</h3>
                    <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-medium">مكتمل</span>
                  </div>
                  <p className="text-gray-600 mb-4">إطلاق المنصة الأساسية مع مميزات إدارة العقارات والعملاء</p>
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">إدارة العقارات</span>
                    <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">CRM</span>
                    <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">واتساب</span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative pr-8">
                ...
                <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-xl">المرحلة الثانية - جاري العمل</h3>
                    <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-medium">قيد التطوير</span>
                  </div>
                  <p className="text-gray-600 mb-4">تطوير الذكاء الاصطناعي وتحسين تجربة المستخدم</p>
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">ذكاء اصطناعي</span>
                    <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">تحليلات متقدمة</span>
                    <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">أتمتة العمليات</span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative pr-8">
                ...
                <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-xl">المرحلة الثالثة - قريباً</h3>
                    <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-medium">مخطط</span>
                  </div>
                  <p className="text-gray-600 mb-4">إطلاق تطبيق الجوال والتكامل مع منصات خارجية</p>
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">تطبيق الجوال</span>
                    <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">API متقدم</span>
                    <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">تكاملات خارجية</span>
                  </div>
                </div>
              </div>
            </div>
