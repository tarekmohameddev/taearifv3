          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-center lg:text-right fade-in-up">
              ...
              <p className="text-xl lg:text-2xl text-gray-200 mb-10 text-pretty leading-relaxed">
                من رسائل عشوائية على الواتساب… إلى موقع عقاري مرتب واحترافي يجمع
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">العملاء يتواصلون معك مباشرة</p>
                  </div>
                </div>
              </div>
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">فريق سعودي يساعدك في كل شيء</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            <div className="text-center relative">
              ...
              <h3 className="text-2xl font-bold mb-4 text-black">سجّل حسابك</h3>
      ...
      <footer className="bg-black text-white py-16 px-4">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p className="text-gray-400">© 2025 تعاريف. جميع الحقوق محفوظة.</p>
          </div>
        </div>
      </footer>
    </div>
