...
import { CalendarIcon, ClockIcon, MapPinIcon, ShareIcon, ChevronLeftIcon, ChevronRightIcon } from "lucide-react"
...
export default function PropertyDetail({ property }: PropertyDetailProps) {
  ...
  const handleBookingSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log("Booking submitted:", { ...bookingForm, date: selectedDate, time: selectedTime })
  ...
  const handlePreviousImage = () => {
    const prevIndex = selectedImageIndex > 0 ? selectedImageIndex - 1 : propertyImages.length - 1
    setSelectedImageIndex(prevIndex)
    setSelectedImage(propertyImages[prevIndex])
  }

  const handleNextImage = () => {
    const nextIndex = selectedImageIndex < propertyImages.length - 1 ? selectedImageIndex + 1 : 0
            ...
            <div className="flex flex-col gap-y-8 lg:gap-y-10">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-600 text-sm leading-6 font-normal md:text-base lg:text-xl lg:leading-7">
                  مدخل مستقل، غرفتين نوم بينهم دورة مياه، صالة، مطبخ، وغرفة طعام، مجلس مع دورة مياه، مكيفات شباك، تيار كهربائي مستقل
                </p>
              </div>
              ...
              <div className="relative h-80 md:h-80 xl:h-96 mb-6">
                ...
                <div className="absolute bottom-2 right-2 opacity-50">
                  <div className="w-12 h-12 bg-white/20 rounded flex items-center justify-center">
                    <span className="text-white text-xs font-bold">دليل الجواء</span>
                  </div>
                </div>
              </div>
          ...
          <div className="flex-1">
            <div className="mb-8 md:mb-18">
              <div className="flex flex-col justify-center items-start gap-y-6 md:gap-y-8">
                ...
                <p className="text-gray-600 font-normal text-sm leading-6 md:text-base md:leading-7">
                  مدخل مستقل، غرفتين نوم بينهم دورة مياه، صالة، مطبخ، وغرفة طعام، مجلس مع دورة مياه، مكيفات شباك
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-y-6">
              ...
              <p className="text-sm text-gray-600 font-normal">
                احجز الآن وقم باختيار الوقت والتاريخ المناسب لك، وسيتم التواصل معك لتأكيد الحجز وتقديم التفاصيل اللازمة.
              </p>
              
              <form onSubmit={handleBookingSubmit} className="flex flex-col gap-y-6 md:gap-y-8">
                <div className="flex flex-row gap-x-4">
                  <div className="flex flex-col gap-y-6 flex-1">
                    <label htmlFor="name" className="text-gray-600 text-base font-bold leading-4">
                      الاسم
                    </label>
                    <input
                      id="name"
                  ...
                  <div className="flex flex-col gap-y-6 flex-1">
                    <label htmlFor="phone" className="text-gray-600 text-base font-bold leading-4">
                      رقم الهاتف
                    </label>
                    <input
                      id="phone"
                ...
                <div className="flex flex-row gap-x-4">
                  <div className="flex-1 flex flex-col gap-y-6 relative">
                    <label htmlFor="date" className="text-gray-600 text-base font-bold leading-4">
                      التاريخ
                    </label>
                    <Popover>
                  ...
                  <div className="flex-1 flex flex-col gap-y-6 relative">
                    <label htmlFor="time" className="text-gray-600 text-base font-bold leading-4">
                      الوقت
                    </label>
            ...
            <div>
              ...
              <div className="hidden md:block space-y-8">
                {loadingSimilar ? (
                  <div className="space-y-4">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="flex mb-8 gap-x-6 h-48 w-full rounded-xl px-4 border border-gray-200 shadow-lg animate-pulse">
                  ...
                  <div key={similarProperty.id} className="flex mb-8 gap-x-6 h-48 w-full rounded-xl px-4 border border-gray-200 shadow-lg">
                    <div className="flex-[48.6%] py-8 flex flex-col gap-y-4 justify-center">
                    ...
                    <figure className="relative flex-[42.4%] py-4 rounded-lg overflow-hidden w-full h-full">
                      <div className="bg-white mt-3 absolute w-36 h-7 md:w-29 lg:w-40 xl:w-46 md:h-9 flex items-center justify-between px-3 top-4 md:top-5 lg:top-4 right-2 rounded-md">
                        <div className="flex flex-row items-center justify-center gap-x-1">
                          ...
                          <p className="text-sm md:text-base font-bold text-gray-600">{similarProperty.views}</p>
                        </div>
                        <div className="flex flex-row items-center justify-center gap-x-1">
                          <div className="w-4 h-4 bg-gray-400 rounded"></div>
                          <p className="text-sm md:text-base font-bold text-gray-600">{similarProperty.bedrooms || 0}</p>
                        </div>
                      </div>
                      <Image
              ...
              <div className="block md:hidden">
                <div className="flex gap-4 overflow-x-auto">
                  {loadingSimilar ? (
                    [1, 2, 3].map((i) => (
                      <div key={i} className="relative h-88 md:h-91 flex flex-col justify-center min-w-[280px] animate-pulse">
                    ...
                    similarProperties.map((similarProperty) => (
                    <Link key={similarProperty.id} href={`/${similarProperty.transactionType === "rent" ? "for-rent" : "for-sale"}/${similarProperty.id}`}>
