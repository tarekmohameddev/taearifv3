...
export default function GlobalLayout({ children }: GlobalLayoutProps) {
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="space-y-6">
              ...
              {Array.from({ length: 3 }).map((_, index) => (
                <div key={index} className="bg-white rounded-lg p-6 shadow-sm animate-breathing relative overflow-hidden" style={{ animationDelay: `${index * 0.5}s` }}>
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent animate-shimmer-ultra" style={{ animationDelay: `${index * 1}s` }}></div>
                  <div className="space-y-4 relative z-10">
                    <div className="h-6 bg-gray-200 rounded animate-gentle-fade w-3/4 relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/60 to-transparent animate-shimmer-slow" style={{ animationDelay: `${index * 1 + 1}s` }}></div>
                    </div>
                    <div className="space-y-2">
                      <div className="h-4 bg-gray-100 rounded animate-breathing w-full relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-200/50 to-transparent animate-shimmer-ultra" style={{ animationDelay: `${index * 1 + 1.5}s` }}></div>
                      </div>
                      <div className="h-4 bg-gray-100 rounded animate-breathing w-5/6 relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-200/50 to-transparent animate-shimmer-slow" style={{ animationDelay: `${index * 1 + 2}s` }}></div>
                      </div>
                      <div className="h-4 bg-gray-100 rounded animate-breathing w-4/6 relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-200/50 to-transparent animate-shimmer-ultra" style={{ animationDelay: `${index * 1 + 2.5}s` }}></div>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Global Footer */}
      {FooterComponent && (
        <Suspense fallback={<div className="bg-gray-50 py-8 animate-gentle-fade relative overflow-hidden">
                ...
                {Array.from({ length: 4 }).map((_, index) => (
                  <div key={index} className="space-y-3">
                    <div className="h-5 bg-gray-200 rounded animate-breathing w-3/4 relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300/60 to-transparent animate-shimmer-slow" style={{ animationDelay: `${index * 0.5}s` }}></div>
                    </div>
                    {Array.from({ length: 3 }).map((_, linkIndex) => (
                      <div key={linkIndex} className="h-4 bg-gray-100 rounded animate-gentle-fade w-2/3 relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-200/50 to-transparent animate-shimmer-ultra" style={{ animationDelay: `${index * 0.5 + linkIndex * 0.2}s` }}></div>
                      </div>
                    ))}
                  </div>
                ))}
