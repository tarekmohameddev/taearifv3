          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="relative">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value="riyadh">{t("property.location")}</SelectItem>
                  <SelectItem value="jeddah">{t("property.location")}</SelectItem>
                  <SelectItem value="dammam">{t("property.location")}</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="relative">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value="apartment">{t("property.type")}</SelectItem>
