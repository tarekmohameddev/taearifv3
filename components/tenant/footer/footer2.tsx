  ...
  const getTenantComponentData = () => {
    ...
    if (tenantData.components && Array.isArray(tenantData.components)) {
      for (const component of tenantData.components) {
        if (component.type === "footer" && component.componentName === variantId) {
            ...
            <div className="w-full lg:w-1/2 xl:w-2/5">
                ...
                <ul className="space-y-4 mb-6">
                    <li className="flex items-center gap-3">
                      ...
                      <span className="text-base">{mergedData.content?.contactInfo?.address}</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <a
                      ...
                      >
                        ...
                        <span className="text-base">{mergedData.content?.contactInfo?.email}</span>
                      </a>
                    </li>
                    <li className="flex items-center gap-3">
                      <a
                      ...
                      >
                        ...
                        <span className="text-base">{mergedData.content?.contactInfo?.whatsapp}</span>
                      </a>
                    </li>
                  </ul>
