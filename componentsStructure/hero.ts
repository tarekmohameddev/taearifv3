...
export const heroStructure: ComponentStructure = {
  ...
  variants: [
      ...
      fields: [
          ...
          ]},
        {
          ...
          fields: [
            ...
            { key: "videoStart", label: "Video Start (seconds)", type: "number" },
      ...
      ]},
    {
      ...
      fields: [{ key: "visible", label: "Visible", type: "boolean" },
        {
          key: "title",
          label: "Title",
          type: "text",
            ...
            value: "propertyFilter"}},
        {
          ...
          label: "Background",
          type: "object",
          fields: [{ key: "image", label: "Image URL", type: "image" },
            { key: "alt", label: "Alt Text", type: "text" },
            {
              key: "overlay",
              label: "Overlay",
          ...
          fields: [{ key: "title", label: "Title", type: "text" },
            ...
            { key: "maxWidth", label: "Max Width", type: "text" },
            {
              ...
              fields: [{
                  ...
                  label: "Title Font",
                  type: "object",
                  fields: [{ key: "family", label: "Family", type: "text" },
                    {
                      key: "size",
                      label: "Size",
                      type: "object",
                      fields: [{ key: "desktop", label: "Desktop", type: "text" },
                        { key: "tablet", label: "Tablet", type: "text" },
                        { key: "mobile", label: "Mobile", type: "text" },
                      ]},
                    { key: "weight", label: "Weight", type: "text" },
      ...
      simpleFields: [{ key: "visible", label: "Visible", type: "boolean" },
