              ...
              fields: [
                {
                  ...
                  options: [
                    ...
                    { value: "MessageSquare", label: "Message", iconLibrary: "lucide" },
                    ...
                    { value: "UserCircle", label: "User Circle", iconLibrary: "lucide" },
                    { value: "Users", label: "Users", iconLibrary: "lucide" },
                    { value: "PhoneCall", label: "Phone Call", iconLibrary: "lucide" },
                    { value: "Send", label: "Send", iconLibrary: "lucide" },
                    { value: "AtSign", label: "At Sign", iconLibrary: "lucide" },
                    { value: "Location", label: "Location", iconLibrary: "lucide" },
                    // React Icons - Font Awesome
                    { value: "FaMapMarkerAlt", label: "Map Marker (FA)", iconLibrary: "react-icons" },
                    ...
                    { value: "FaGlobe", label: "Globe (FA)", iconLibrary: "react-icons" },
                    { value: "FaClock", label: "Clock (FA)", iconLibrary: "react-icons" },
                    { value: "FaCalendar", label: "Calendar (FA)", iconLibrary: "react-icons" },
                    { value: "FaUser", label: "User (FA)", iconLibrary: "react-icons" },
                    { value: "FaUsers", label: "Users (FA)", iconLibrary: "react-icons" },
                    // React Icons - Material Design
                    { value: "MdLocationOn", label: "Location (MD)", iconLibrary: "react-icons" },
                    ...
                    { value: "MdLanguage", label: "Language (MD)", iconLibrary: "react-icons" },
                    { value: "MdAccessTime", label: "Access Time (MD)", iconLibrary: "react-icons" },
                    { value: "MdCalendarToday", label: "Calendar (MD)", iconLibrary: "react-icons" },
                    { value: "MdPerson", label: "Person (MD)", iconLibrary: "react-icons" },
