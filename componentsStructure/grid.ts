  ...
  variants: [
    {
      ...
      simpleFields: [
        ...
        { key: "content.emptyMessage", label: "Empty State Message", type: "text" },
        ...
        { key: "layout.columns.mobile", label: "Mobile Columns", type: "number" },
        { key: "layout.columns.tablet", label: "Tablet Columns", type: "number" },
        { key: "layout.columns.desktop", label: "Desktop Columns", type: "number" },
        { key: "layout.columns.large", label: "Large Desktop Columns", type: "number" },
        { key: "layout.padding.top", label: "Top Padding", type: "text" },
        { key: "layout.padding.bottom", label: "Bottom Padding", type: "text" },
        { key: "layout.padding.horizontal", label: "Horizontal Padding", type: "text" },
      ],
    },
  ],
};
