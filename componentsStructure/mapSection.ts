  ...
  variants: [
    {
      ...
      simpleFields: [
        { key: "visible", label: "Visible", type: "boolean" },
        { key: "map.enabled", label: "Show Map", type: "boolean" },
        { key: "map.apiKey", label: "Google Maps API Key", type: "text" },
        { key: "map.center.lat", label: "Map Latitude", type: "number" },
        { key: "map.center.lng", label: "Map Longitude", type: "number" },
        { key: "map.zoom", label: "Map Zoom Level", type: "number" },
        { key: "markers.enabled", label: "Show Markers", type: "boolean" },
        {
          key: "infoWindow.enabled",
        ...
        { key: "overlay.enabled", label: "Show Map Overlay", type: "boolean" },
        {
          key: "animations.mapLoad.enabled",
          label: "Enable Map Load Animation",
          type: "boolean",
        },
        {
          key: "animations.markers.enabled",
          label: "Enable Markers Animation",
          type: "boolean",
        },
        {
          key: "animations.content.enabled",
