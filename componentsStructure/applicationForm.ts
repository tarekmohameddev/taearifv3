  ...
  variants: [
    {
      ...
      simpleFields: [
        ...
        { key: "header.description", label: "Form Description", type: "textarea" },
        { key: "form.fields.name.label", label: "Name Field Label", type: "text" },
        { key: "form.fields.phone.label", label: "Phone Field Label", type: "text" },
        { key: "form.fields.address.label", label: "Address Field Label", type: "text" },
        { key: "form.fields.requester_type.label", label: "Requester Type Label", type: "text" },
        { key: "form.fields.date.label", label: "Date Field Label", type: "text" },
        { key: "form.fields.time.label", label: "Time Field Label", type: "text" },
        { key: "form.fields.offer_type.label", label: "Offer Type Label", type: "text" },
        { key: "form.fields.description.label", label: "Description Field Label", type: "text" },
        { key: "form.submitButton.text", label: "Submit Button Text", type: "text" },
        { key: "form.imageUpload.label", label: "Image Upload Label", type: "text" },
        { key: "form.imageUpload.description", label: "Image Upload Description", type: "textarea" },
      ],
    },
  ],
};
