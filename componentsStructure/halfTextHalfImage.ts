      ...
      fields: [
          ...
          ]},
        {
          ...
          fields: [{
              ...
              label: "Padding",
              type: "object",
              fields: [{ key: "top", label: "Top", type: "number" },
                { key: "bottom", label: "Bottom", type: "number" },
                { key: "left", label: "Left", type: "number" },
                { key: "right", label: "Right", type: "number" },
              ]},
          ]},
        {
          ...
          fields: [{ key: "title", label: "Title", type: "text" },
              ...
              ]},
            {
              ...
              label: "Button",
              type: "object",
              fields: [{ key: "text", label: "Button Text", type: "text" },
                { key: "url", label: "Button URL", type: "text" },
                { key: "enabled", label: "Show Button", type: "boolean" },
              ]},
          ]},
        {
          ...
          fields: [{
              ...
              ]},
            {
              ...
              label: "Text Colors",
              type: "object",
              fields: [{ key: "title", label: "Title Color", type: "color" },
          ...
          ]},
        {
          ...
          label: "Image",
          type: "object",
          fields: [{ key: "visible", label: "Show Image", type: "boolean" },
            { key: "src", label: "Image Source", type: "image" },
            { key: "alt", label: "Alt Text", type: "text" },
          ]},
        {
          ...
          fields: [{
              ...
              label: "Mobile",
              type: "object",
              fields: [{ key: "textOrder", label: "Text Order", type: "number" },
                { key: "imageOrder", label: "Image Order", type: "number" },
                { key: "textWidth", label: "Text Width", type: "text" },
                { key: "imageWidth", label: "Image Width", type: "text" },
      ...
      fields: [
          ...
          ]},
        {
          ...
          fields: [{
              ...
              label: "Padding",
              type: "object",
              fields: [{ key: "top", label: "Top", type: "text" },
      ...
      fields: [
          ...
          ]},
        {
          ...
          fields: [{
              ...
              label: "Mobile",
              type: "object",
              fields: [{ key: "imageOrder", label: "Image Order", type: "number" },
                { key: "textOrder", label: "Text Order", type: "number" },
                { key: "imageHeight", label: "Image Height", type: "text" },
              ]},
            {
