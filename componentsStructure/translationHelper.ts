...
export function translateLabel(
  ...
  const labelMappings: Record<string, string> = {
    ...
    "Small Vertical Padding": "components_structure.inputs.small_vertical_padding",
    ...
    "Submit Button Gradient": "components_structure.inputs.submit_button_gradient",
    "Submit Button Settings": "components_structure.inputs.submit_button_settings",
    ...
    "Cards Layout Settings": "components_structure.inputs.cards_layout_settings",
    ...
    "Fields Layout Settings": "components_structure.inputs.fields_layout_settings",
    ...
    "Field Options (for Select/Radio)": "components_structure.inputs.field_options",
