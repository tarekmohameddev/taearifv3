...
export const getDefaultLogosTickerData = (): ComponentData => ({
  ...
  content: {
    ...
    subtitle: "من الشركات الناشئة إلى الشركات الكبرى يعتمد عملائنا على رواد لتبسيط العمليات وتعزيز الرؤية وتسريع النمو."
  },
...
export const logosTickerFunctions = {
  ...
  updateByPath: (state: any, variantId: string, path: string, value: any) => {
    const source = state.logosTickerStates[variantId] || getDefaultLogosTickerData();
