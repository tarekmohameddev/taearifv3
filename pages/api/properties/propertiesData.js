...
export const properties = [
  // عقارات للإيجار
  {
    ...
    description:
      "شقة أرضية فاخرة في موقع مميز، مدخل مستقل، غرفتين نوم بينهم دورة مياه، صالة، مطبخ، وغرفة طعام، مجلس مع دورة مياه، مكيفات شباك، تيار كهربائي مستقل",
  ...
  },
  {
    ...
    description:
      "شقة عوائل مريحة في مخطط الرياح، غرفتين نوم، صالة واسعة، مطبخ مجهز، دورة مياه واحدة، مكيفات شباك",
  ...
  },
  {
    ...
    description:
      "شقة عوائل اقتصادية في حي التعليم، قريبة من المسجد والمدارس، غرفتين نوم، صالة، مطبخ صغير",
  ...
  },
  {
    ...
    description:
      "شقة عوائل واسعة في الخزان، أربع غرف نوم، صالتين، مطبخ كبير، دورتين مياه، مكيفات شباك، قريبة من المسجد",
  ...
  },
  {
    ...
    description:
      "دور علوي واسع في حي الروابي، خمس غرف نوم، ثلاث دورات مياه، صالة كبيرة، مطبخ مجهز، مجلس منفصل، مكيفات شباك",
  ...
  },
  {
    ...
    description:
      "شقة دوبلكس فاخرة في حي النرجس، أربع غرف نوم، ثلاث دورات مياه، صالة كبيرة، مطبخ مجهز، مجلس منفصل، حديقة صغيرة",
  ...
  },
  {
    ...
    description:
      "شقة عوائل حديثة في حي العليا، ثلاث غرف نوم، دورتين مياه، صالة، مطبخ، موقف سيارات، مكيفات مركزية",
  ...
  },
  {
    ...
    description:
      "فيلا عائلية للإيجار في حي الشاطئ، ست غرف نوم، أربع دورات مياه، صالة كبيرة، مطبخ مجهز، مجلس منفصل، حديقة، موقف سيارات",
    features: [
      "ست غرف نوم",
      "أربع دورات مياه",
      "حديقة",
  ...
  },
  {
    ...
    description:
      "شقة عوائل هادئة في حي الورود، ثلاث غرف نوم، دورتين مياه، صالة، مطبخ، قريبة من المسجد والمدارس",
    features: [
      "ثلاث غرف نوم",
      "قريبة من المسجد",
      "قريبة من المدارس",
  ...
  },
  {
    ...
    description:
      "دور مستقل للإيجار في حي الجامعة، أربع غرف نوم، ثلاث دورات مياه، صالة، مطبخ، مجلس منفصل، قريب من الجامعة",
    features: [
      "أربع غرف نوم",
      "ثلاث دورات مياه",
      "مجلس منفصل",
  ...
  },
  {
    ...
    description:
      "شقة عوائل مريحة في حي الشاطئ، ثلاث غرف نوم، دورتين مياه، صالة، مطبخ، قريبة من البحر",
  ...
  },
  {
    ...
    description:
      "شقة عوائل اقتصادية في حي النزهة، غرفتين نوم، دورة مياه واحدة، صالة، مطبخ، سعر مناسب",
  ...
  },
  {
    ...
    description:
      "فيلا فاخرة للإيجار في حي النرجس، سبع غرف نوم، خمس دورات مياه، صالة كبيرة، مطبخ مجهز، مجلس منفصل، حديقة كبيرة، موقف سيارات",
    features: [
      "سبع غرف نوم",
      "خمس دورات مياه",
      "حديقة كبيرة",
  ...
  // عقارات للبيع
  {
    ...
    description:
      "فيلا فاخرة للبيع في حي النرجس، ست غرف نوم، أربع دورات مياه، صالة كبيرة، مطبخ مجهز، مجلس منفصل، حديقة، موقف سيارات",
    features: [
      "ست غرف نوم",
      "أربع دورات مياه",
      "حديقة",
  ...
  },
  {
    ...
    description:
      "شقة للبيع في حي العليا، ثلاث غرف نوم، دورتين مياه، صالة، مطبخ، موقف سيارات",
  ...
  },
  {
    ...
    description:
      "فيلا عائلية للبيع في حي الشاطئ، خمس غرف نوم، أربع دورات مياه، صالة كبيرة، مطبخ مجهز، مجلس منفصل، حديقة، موقف سيارات",
    features: [
      "خمس غرف نوم",
      "أربع دورات مياه",
      "حديقة",
  ...
  },
  {
    ...
    description:
      "شقة دوبلكس للبيع في حي الورود، أربع غرف نوم، ثلاث دورات مياه، صالة كبيرة، مطبخ مجهز، مجلس منفصل، حديقة صغيرة",
    features: ["أربع غرف نوم", "ثلاث دورات مياه", "حديقة صغيرة", "مجلس منفصل"],
    location: {
      lat: 26.5854641,
      lng: 43.7168531,
  ...
  },
  {
    ...
    description:
      "دور مستقل للبيع في حي الجامعة، أربع غرف نوم، ثلاث دورات مياه، صالة، مطبخ، مجلس منفصل، قريب من الجامعة",
    features: [
      "أربع غرف نوم",
      "ثلاث دورات مياه",
      "مجلس منفصل",
  ...
  },
  {
    ...
    description:
      "شقة عوائل للبيع في حي الشاطئ، ثلاث غرف نوم، دورتين مياه، صالة، مطبخ، قريبة من البحر",
    features: ["ثلاث غرف نوم", "قريبة من البحر", "موقع مميز", "مكيفات شباك"],
    location: {
      lat: 26.6054641,
      lng: 43.7368531,
  ...
  },
  {
    ...
    description:
      "شقة اقتصادية للبيع في حي النزهة، غرفتين نوم، دورة مياه واحدة، صالة، مطبخ، سعر مناسب",
    features: ["غرفتين نوم", "سعر مناسب", "موقع جيد", "مكيفات شباك"],
    location: {
      lat: 26.6154641,
      lng: 43.7468531,
  ...
  },
  {
    ...
    description:
      "فيلا فاخرة للبيع في حي النرجس، سبع غرف نوم، خمس دورات مياه، صالة كبيرة، مطبخ مجهز، مجلس منفصل، حديقة كبيرة، موقف سيارات",
    features: [
      "سبع غرف نوم",
      "خمس دورات مياه",
      "حديقة كبيرة",
  ...
  },
  {
    ...
    description:
      "شقة عوائل حديثة للبيع في حي العليا، ثلاث غرف نوم، دورتين مياه، صالة، مطبخ، موقف سيارات، مكيفات مركزية",
    features: ["ثلاث غرف نوم", "موقف سيارات", "مكيفات مركزية", "موقع مميز"],
    location: {
      lat: 26.5654641,
      lng: 43.6968531,
  ...
  },
  {
    ...
    description:
      "دور علوي للبيع في حي الروابي، خمس غرف نوم، ثلاث دورات مياه، صالة كبيرة، مطبخ مجهز، مجلس منفصل، مكيفات شباك",
    features: ["خمس غرف نوم", "ثلاث دورات مياه", "مجلس منفصل", "مطبخ مجهز"],
    location: {
      lat: 26.5454641,
      lng: 43.6768531,
  ...
  },
  {
    ...
    description:
      "شقة عوائل واسعة للبيع في الخزان، أربع غرف نوم، صالتين، مطبخ كبير، دورتين مياه، مكيفات شباك، قريبة من المسجد",
    features: ["أربع غرف نوم", "صالتين", "مطبخ كبير", "قريبة من المسجد"],
    location: {
      lat: 26.5354641,
      lng: 43.6668531,
  ...
  },
  {
    ...
    description:
      "شقة عوائل اقتصادية للبيع في حي التعليم، قريبة من المسجد والمدارس، غرفتين نوم، صالة، مطبخ صغير",
    features: ["قريبة من المسجد", "قريبة من المدارس", "سعر اقتصادي"],
    location: {
      lat: 26.5254641,
      lng: 43.6568531,
